...
DOUYIN_SIGN_JS = open('libs/douyin.js', encoding='utf-8-sig').read()
...
async def get_a_bogus(url: str, params: str, post_data: dict, user_agent: str, page: Page = None):
    ...
    if page:
        try:
            return await get_a_bogus_from_playwright(url, params, post_data, user_agent, page)
        except Exception:
            pass
...
def get_a_bogus_from_js(url: str, params: str, user_agent: str):
    ...
    global douyin_sign_obj
    if douyin_sign_obj is None:
        douyin_sign_obj = execjs.compile(DOUYIN_SIGN_JS)
    return douyin_sign_obj.call(sign_js_name, params, user_agent)



async def get_a_bogus_from_playwright(url: str, params: str, post_data: dict, user_agent: str, page: Page):
    """
    ...
    return await page.evaluate(
        """([source, signName, params, ua]) => {
            ...
            return window[signName](params, ua);
        }""",
        [DOUYIN_SIGN_JS, sign_js_name, params, user_agent],
    )
